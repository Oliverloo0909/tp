...
public class CommandTestUtil {
    ...
    public static final String TAG_DESC_FRIEND = " " + PREFIX_GROUP + VALID_GROUP_FRIEND;
    public static final String TAG_DESC_HUSBAND = " " + PREFIX_GROUP + VALID_GROUP_HUSBAND;
    ...
    static {
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                ...
                .withGroups(VALID_TAG_, VALID_GROUP_FRIEND).build();
    }
